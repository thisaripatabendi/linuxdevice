...
function onRequest(context) {
	...
	//var websocketEndpointForStream1 = websocketEndpoint + "/secured-websocket/org.wso2.iot.devices.batterylevelsensor/1.0.0?deviceId=" + device.deviceIdentifier + "&deviceType=" + device.type;
    var websocketEndpointForStream1 = "wss://localhost:9445/outputwebsocket/EventPublisherbatterylevelsensor";

    //var websocketEndpointForStream2 = websocketEndpoint + "/secured-websocket/org.wso2.iot.devices.batterystatussensor/1.0.0?deviceId=" + device.deviceIdentifier + "&deviceType=" + device.type;
    var websocketEndpointForStream2 = "wss://localhost:9445/outputwebsocket/EventPublisherbatterystatussensor";
    ...
    var websocketEndpointForStream6 = "wss://localhost:9445/outputwebsocket/EventPublisherloadaveragesensor";
