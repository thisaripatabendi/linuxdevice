...
DEVICE_INFO = '{{"event":{{"metaData":{{"owner":"' + DEVICE_OWNER + '","type":"linuxdevice","deviceId":"' + DEVICE_ID + '","time":{}}},"payloadData":{{"batterylevelsensor":{:.2f}, "batterystatussensor":{:.2f}, "cpuusagesensor":{:.2f}}}}}}}'
